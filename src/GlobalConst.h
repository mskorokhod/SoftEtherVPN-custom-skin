...
#define	GC_SVC_NAME_VPNSERVER		"UGGAMESERVERDEV"
#define	GC_SVC_NAME_VPNCLIENT		"UGGAMECLIENTDEV"
#define	GC_SVC_NAME_VPNBRIDGE		"UGGAMEBRIDGEDEV"



//// Registry

#define	GC_REG_COMPANY_NAME			"Unite Gaming"
